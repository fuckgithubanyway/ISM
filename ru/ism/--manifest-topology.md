...
1. `--manifest-[name].md` — лексикографически по имени файла;
2. файлы с `order` — по числовому `order`;
3. файлы без `order` — по имени файла.
...
Manifest не имеет `order`. При каноническом отображении Manifest Set всегда предшествует Meta и Spec. Канонический порядок Manifest — лексикографический по имени файла и не несёт семантики.
